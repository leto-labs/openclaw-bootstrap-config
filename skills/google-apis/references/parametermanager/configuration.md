# Parameter Manager API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/parametermanager.googleapis.com).
...
- **Root URL**: `https://parametermanager.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
