# SAS Portal API - Configuration

## Enable the API

```bash
gcloud services enable sasportal.googleapis.com
```

Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/sasportal.googleapis.com).
