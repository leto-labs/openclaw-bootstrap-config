# BigQuery Data Policy API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/bigquerydatapolicy.googleapis.com).
...
- **Root URL**: `https://bigquerydatapolicy.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
