# Firebase App Hosting API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/firebaseapphosting.googleapis.com).
...
- **Root URL**: `https://firebaseapphosting.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
