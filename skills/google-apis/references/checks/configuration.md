...
```bash
gcloud services enable checks.googleapis.com
```

Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/checks.googleapis.com).
...
- **Root URL**: `https://checks.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
