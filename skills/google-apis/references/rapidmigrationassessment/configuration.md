# Rapid Migration Assessment API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/rapidmigrationassessment.googleapis.com).
...
- **Root URL**: `https://rapidmigrationassessment.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
