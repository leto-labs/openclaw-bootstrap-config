# Infrastructure Manager API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/config.googleapis.com).
...
- **Root URL**: `https://config.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
