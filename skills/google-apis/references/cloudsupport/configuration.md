# Google Cloud Support API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/cloudsupport.googleapis.com).
...
- **Root URL**: `https://cloudsupport.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
