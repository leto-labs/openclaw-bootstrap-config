...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/netapp.googleapis.com).
...
- **Root URL**: `https://netapp.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
