...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/datastream.googleapis.com).
...
- **Root URL**: `https://datastream.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
