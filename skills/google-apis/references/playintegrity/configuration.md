...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/playintegrity.googleapis.com).
...
- **Root URL**: `https://playintegrity.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
