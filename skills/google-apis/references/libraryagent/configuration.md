# Library Agent API - Configuration

## Enable the API

```bash
gcloud services enable libraryagent.googleapis.com
```

Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/libraryagent.googleapis.com).
