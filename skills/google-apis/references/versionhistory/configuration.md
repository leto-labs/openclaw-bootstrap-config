# versionhistory.googleapis.com API - Configuration

## Enable the API

```bash
gcloud services enable versionhistory.googleapis.com
```

Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/versionhistory.googleapis.com).
...
- **Root URL**: `https://versionhistory.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
