# Google Marketing Platform Admin API - Gotchas & Troubleshooting
...
- Always enable `marketingplatformadmin.googleapis.com` in your GCP project before making calls
