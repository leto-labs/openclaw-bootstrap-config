# Payments Reseller Subscription API - Gotchas & Troubleshooting
...
- Always enable `paymentsresellersubscription.googleapis.com` in your GCP project before making calls
