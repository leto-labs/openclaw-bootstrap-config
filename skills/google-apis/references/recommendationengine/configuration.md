# Recommendations AI (Beta) - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/recommendationengine.googleapis.com).
