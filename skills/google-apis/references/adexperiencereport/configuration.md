# Ad Experience Report API - Configuration

## Enable the API

```bash
gcloud services enable adexperiencereport.googleapis.com
```

Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/adexperiencereport.googleapis.com).
