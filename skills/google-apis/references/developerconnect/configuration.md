# Developer Connect API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/developerconnect.googleapis.com).
...
- **Root URL**: `https://developerconnect.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
