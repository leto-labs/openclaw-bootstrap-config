# VMware Engine API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/vmwareengine.googleapis.com).
...
- **Root URL**: `https://vmwareengine.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
