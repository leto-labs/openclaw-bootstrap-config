# Cluster Director API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/hypercomputecluster.googleapis.com).
...
- **Root URL**: `https://hypercomputecluster.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
