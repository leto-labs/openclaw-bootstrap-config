# Migration Center API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/migrationcenter.googleapis.com).
...
- **Root URL**: `https://migrationcenter.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
