# Secure Source Manager API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/securesourcemanager.googleapis.com).
...
- **Root URL**: `https://securesourcemanager.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
