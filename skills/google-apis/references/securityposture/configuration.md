# Security Posture API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/securityposture.googleapis.com).
...
- **Root URL**: `https://securityposture.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
