...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/alloydb.googleapis.com).
...
- **Root URL**: `https://alloydb.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
