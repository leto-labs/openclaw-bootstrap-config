# Contact Center AI Platform API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/contactcenteraiplatform.googleapis.com).
...
- **Root URL**: `https://contactcenteraiplatform.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
