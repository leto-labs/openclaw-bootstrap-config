# VM Migration API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/vmmigration.googleapis.com).
...
- **Root URL**: `https://vmmigration.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
