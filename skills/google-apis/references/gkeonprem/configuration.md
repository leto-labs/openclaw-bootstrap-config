...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/gkeonprem.googleapis.com).
...
- **Root URL**: `https://gkeonprem.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
