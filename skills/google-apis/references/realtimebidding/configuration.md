# Real-time Bidding API - Configuration

## Enable the API

```bash
gcloud services enable realtimebidding.googleapis.com
```

Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/realtimebidding.googleapis.com).
