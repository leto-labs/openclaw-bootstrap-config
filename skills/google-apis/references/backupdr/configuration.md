# Backup and DR Service API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/backupdr.googleapis.com).
...
- **Root URL**: `https://backupdr.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
