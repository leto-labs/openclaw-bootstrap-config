# Document AI Warehouse API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/contentwarehouse.googleapis.com).
...
- **Root URL**: `https://contentwarehouse.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
