# Cloud Storage for Firebase API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/firebasestorage.googleapis.com).
