# Workload Manager API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/workloadmanager.googleapis.com).
...
- **Root URL**: `https://workloadmanager.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
