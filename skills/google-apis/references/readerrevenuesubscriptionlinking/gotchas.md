# Reader Revenue Subscription Linking API - Gotchas & Troubleshooting
...
- Always enable `readerrevenuesubscriptionlinking.googleapis.com` in your GCP project before making calls
