...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/apphub.googleapis.com).
...
- **Root URL**: `https://apphub.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
