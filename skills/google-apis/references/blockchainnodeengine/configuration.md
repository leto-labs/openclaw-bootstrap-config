# Blockchain Node Engine API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/blockchainnodeengine.googleapis.com).
...
- **Root URL**: `https://blockchainnodeengine.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
