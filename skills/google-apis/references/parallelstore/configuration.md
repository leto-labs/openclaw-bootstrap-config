# Parallelstore API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/parallelstore.googleapis.com).
...
- **Root URL**: `https://parallelstore.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
