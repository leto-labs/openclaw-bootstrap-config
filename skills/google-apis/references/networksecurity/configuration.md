# Network Security API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/networksecurity.googleapis.com).
...
- **Root URL**: `https://networksecurity.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
