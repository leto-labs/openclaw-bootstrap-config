# Serverless VPC Access API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/vpcaccess.googleapis.com).
...
- **Root URL**: `https://vpcaccess.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
