# Google Workspace Alert Center API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/alertcenter.googleapis.com).

## Auth Scopes

| Scope | Description |
|-------|-------------|
| `https://www.googleapis.com/auth/apps.alerts` | See and delete your domain's Google Workspace alerts, and send alert feedback |
