# Google Play Grouping API - Configuration

## Enable the API

```bash
gcloud services enable playgrouping.googleapis.com
```

Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/playgrouping.googleapis.com).
...
- **Root URL**: `https://playgrouping.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
