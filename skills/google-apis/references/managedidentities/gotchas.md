# Managed Service for Microsoft Active Directory API - Gotchas & Troubleshooting
...
- Always enable `managedidentities.googleapis.com` in your GCP project before making calls
