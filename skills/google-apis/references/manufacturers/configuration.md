# Manufacturer Center API - Configuration

## Enable the API

```bash
gcloud services enable manufacturers.googleapis.com
```

Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/manufacturers.googleapis.com).
