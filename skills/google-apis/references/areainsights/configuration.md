# Places Aggregate API - Configuration

## Enable the API

```bash
gcloud services enable areainsights.googleapis.com
```

Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/areainsights.googleapis.com).
...
- **Root URL**: `https://areainsights.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
