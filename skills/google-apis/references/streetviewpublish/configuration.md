# Street View Publish API - Configuration

## Enable the API

```bash
gcloud services enable streetviewpublish.googleapis.com
```

Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/streetviewpublish.googleapis.com).
