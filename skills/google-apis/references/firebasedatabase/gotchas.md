# Firebase Realtime Database Management API - Gotchas & Troubleshooting
...
- Always enable `firebasedatabase.googleapis.com` in your GCP project before making calls
