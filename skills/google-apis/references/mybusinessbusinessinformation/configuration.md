# My Business Business Information API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/mybusinessbusinessinformation.googleapis.com).
...
- **Root URL**: `https://mybusinessbusinessinformation.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
