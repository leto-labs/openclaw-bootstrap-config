# Authorized Buyers Marketplace API - Gotchas & Troubleshooting
...
- Always enable `authorizedbuyersmarketplace.googleapis.com` in your GCP project before making calls
