# Cloud Workstations API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/workstations.googleapis.com).
...
- **Root URL**: `https://workstations.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
