# Google Play Games Services Publishing API - Gotchas & Troubleshooting
...
- Always enable `gamesConfiguration.googleapis.com` in your GCP project before making calls
