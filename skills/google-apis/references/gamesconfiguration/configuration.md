# Google Play Games Services Publishing API - Configuration

## Enable the API

```bash
gcloud services enable gamesConfiguration.googleapis.com
```

Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/gamesConfiguration.googleapis.com).
