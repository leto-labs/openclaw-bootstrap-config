...
- **API**: `mybusinessqanda`
- **Version**: `v1`
- **Base URL**: `https://mybusinessqanda.googleapis.com/`
...
listings. Note - If you have a quota of 0 after enabling the API, please request
for GBP API access.
...
// Example: list or get
// const res = await mybusinessqanda.someResource.list({ ... });
```
