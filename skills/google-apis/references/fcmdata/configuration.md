# Firebase Cloud Messaging Data API - Configuration

## Enable the API

```bash
gcloud services enable fcmdata.googleapis.com
```

Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/fcmdata.googleapis.com).
...
- **Root URL**: `https://fcmdata.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
