...
```bash
gcloud services enable androidenterprise.googleapis.com
```

Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/androidenterprise.googleapis.com).
