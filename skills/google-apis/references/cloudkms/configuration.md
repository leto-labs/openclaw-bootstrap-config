# Cloud Key Management Service (KMS) API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/cloudkms.googleapis.com).
