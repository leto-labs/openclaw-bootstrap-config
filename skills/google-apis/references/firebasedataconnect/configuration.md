# Firebase Data Connect API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/firebasedataconnect.googleapis.com).
...
- **Root URL**: `https://firebasedataconnect.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
