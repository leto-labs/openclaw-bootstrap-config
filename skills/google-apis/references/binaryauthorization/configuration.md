# Binary Authorization API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/binaryauthorization.googleapis.com).
