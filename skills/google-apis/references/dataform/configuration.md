...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/dataform.googleapis.com).
...
- **Root URL**: `https://dataform.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
