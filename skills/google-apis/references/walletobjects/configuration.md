...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/walletobjects.googleapis.com).
...
- **Root URL**: `https://walletobjects.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
