...
```bash
gcloud services enable civicinfo.googleapis.com
```

Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/civicinfo.googleapis.com).
