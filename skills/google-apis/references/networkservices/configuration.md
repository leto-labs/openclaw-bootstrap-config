# Network Services API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/networkservices.googleapis.com).
...
- **Root URL**: `https://networkservices.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
