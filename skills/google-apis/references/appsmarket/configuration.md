# Google Workspace Marketplace API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/appsmarket.googleapis.com).
...
- **Root URL**: `https://appsmarket.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
