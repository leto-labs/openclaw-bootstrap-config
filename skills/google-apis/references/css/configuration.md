...
```bash
gcloud services enable css.googleapis.com
```

Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/css.googleapis.com).
...
- **Root URL**: `https://css.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
