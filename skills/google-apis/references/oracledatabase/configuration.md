# Oracle Database@Google Cloud API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/oracledatabase.googleapis.com).
...
- **Root URL**: `https://oracledatabase.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
