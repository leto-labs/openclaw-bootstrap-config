# Data pipelines API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/datapipelines.googleapis.com).
...
- **Root URL**: `https://datapipelines.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
