# Local Services API - Configuration

## Enable the API

```bash
gcloud services enable localservices.googleapis.com
```

Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/localservices.googleapis.com).
