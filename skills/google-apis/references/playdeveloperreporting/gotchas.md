# Google Play Developer Reporting API - Gotchas & Troubleshooting
...
- Always enable `playdeveloperreporting.googleapis.com` in your GCP project before making calls
