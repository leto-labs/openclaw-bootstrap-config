# My Business Lodging API - Configuration

## Enable the API

```bash
gcloud services enable mybusinesslodging.googleapis.com
```

Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/mybusinesslodging.googleapis.com).
