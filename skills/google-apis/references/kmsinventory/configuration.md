# KMS Inventory API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/kmsinventory.googleapis.com).
...
- **Root URL**: `https://kmsinventory.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
