...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/apihub.googleapis.com).
...
- **Root URL**: `https://apihub.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
