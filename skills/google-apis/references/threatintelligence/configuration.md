...
```bash
gcloud services enable threatintelligence.googleapis.com
```

Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/threatintelligence.googleapis.com).
...
- **Root URL**: `https://threatintelligence.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
