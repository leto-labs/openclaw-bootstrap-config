# Google Play Custom App Publishing API - Configuration

## Enable the API

```bash
gcloud services enable playcustomapp.googleapis.com
```

Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/playcustomapp.googleapis.com).
