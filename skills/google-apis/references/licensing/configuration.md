# Enterprise License Manager API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/licensing.googleapis.com).

## Auth Scopes

| Scope | Description |
|-------|-------------|
| `https://www.googleapis.com/auth/apps.licensing` | View and manage Google Workspace licenses for your domain |
