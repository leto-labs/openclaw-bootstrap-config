# AdSense Platform API - Configuration

## Enable the API

```bash
gcloud services enable adsenseplatform.googleapis.com
```

Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/adsenseplatform.googleapis.com).
...
- **Root URL**: `https://adsenseplatform.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
