# Firebase App Distribution API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/firebaseappdistribution.googleapis.com).
...
- **Root URL**: `https://firebaseappdistribution.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
