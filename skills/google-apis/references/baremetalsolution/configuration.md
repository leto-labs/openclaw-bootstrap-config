# Bare Metal Solution API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/baremetalsolution.googleapis.com).
...
- **Root URL**: `https://baremetalsolution.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
