# Travel Impact Model API - Configuration

## Enable the API

```bash
gcloud services enable travelimpactmodel.googleapis.com
```

Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/travelimpactmodel.googleapis.com).
...
- **Root URL**: `https://travelimpactmodel.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
