...
```bash
gcloud services enable apim.googleapis.com
```

Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/apim.googleapis.com).
...
- **Root URL**: `https://apim.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
