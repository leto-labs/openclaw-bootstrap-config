# Abusive Experience Report API - Configuration

## Enable the API

```bash
gcloud services enable abusiveexperiencereport.googleapis.com
```

Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/abusiveexperiencereport.googleapis.com).
