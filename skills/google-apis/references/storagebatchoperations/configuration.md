# Storage Batch Operations API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/storagebatchoperations.googleapis.com).
...
- **Root URL**: `https://storagebatchoperations.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
