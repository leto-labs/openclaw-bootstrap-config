# Contact Center AI Insights API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/contactcenterinsights.googleapis.com).
...
- **Root URL**: `https://contactcenterinsights.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
