# Digital Asset Links API - Configuration

## Enable the API

```bash
gcloud services enable digitalassetlinks.googleapis.com
```

Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/digitalassetlinks.googleapis.com).
