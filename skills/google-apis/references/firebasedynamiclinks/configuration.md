# Firebase Dynamic Links API - Configuration

## Enable the API

```bash
gcloud services enable firebasedynamiclinks.googleapis.com
```

Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/firebasedynamiclinks.googleapis.com).
