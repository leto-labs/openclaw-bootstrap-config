# My Business Notifications API - Configuration

## Enable the API

```bash
gcloud services enable mybusinessnotifications.googleapis.com
```

Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/mybusinessnotifications.googleapis.com).
...
- **Root URL**: `https://mybusinessnotifications.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
