# Cloud Dataplex API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/dataplex.googleapis.com).
...
- **Root URL**: `https://dataplex.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
