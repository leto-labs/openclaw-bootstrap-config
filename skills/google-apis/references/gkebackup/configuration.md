# Backup for GKE API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/gkebackup.googleapis.com).
...
- **Root URL**: `https://gkebackup.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
