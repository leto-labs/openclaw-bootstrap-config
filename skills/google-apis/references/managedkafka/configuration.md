# Managed Service for Apache Kafka API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/managedkafka.googleapis.com).
...
- **Root URL**: `https://managedkafka.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
