# Application Integration API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/integrations.googleapis.com).
...
- **Root URL**: `https://integrations.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
