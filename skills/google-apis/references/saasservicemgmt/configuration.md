# SaaS Runtime API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/saasservicemgmt.googleapis.com).
...
- **Root URL**: `https://saasservicemgmt.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
