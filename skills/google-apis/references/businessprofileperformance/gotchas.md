# Business Profile Performance API - Gotchas & Troubleshooting
...
- Always enable `businessprofileperformance.googleapis.com` in your GCP project before making calls
