# Business Profile Performance API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/businessprofileperformance.googleapis.com).
...
- **Root URL**: `https://businessprofileperformance.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
