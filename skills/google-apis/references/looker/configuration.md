# Looker (Google Cloud core) API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/looker.googleapis.com).
...
- **Root URL**: `https://looker.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
