# Certificate Manager API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/certificatemanager.googleapis.com).
...
- **Root URL**: `https://certificatemanager.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
