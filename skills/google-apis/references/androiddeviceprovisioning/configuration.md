# Android Device Provisioning Partner API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/androiddeviceprovisioning.googleapis.com).
