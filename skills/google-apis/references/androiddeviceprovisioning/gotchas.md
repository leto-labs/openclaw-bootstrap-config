# Android Device Provisioning Partner API - Gotchas & Troubleshooting
...
- Always enable `androiddeviceprovisioning.googleapis.com` in your GCP project before making calls
