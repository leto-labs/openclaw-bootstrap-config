# My Business Verifications API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/mybusinessverifications.googleapis.com).
...
- **Root URL**: `https://mybusinessverifications.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
