# Cloud Commerce Partner Procurement API - Gotchas & Troubleshooting
...
- Always enable `cloudcommerceprocurement.googleapis.com` in your GCP project before making calls
