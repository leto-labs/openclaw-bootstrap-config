# Cloud Commerce Partner Procurement API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/cloudcommerceprocurement.googleapis.com).
...
- **Root URL**: `https://cloudcommerceprocurement.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
