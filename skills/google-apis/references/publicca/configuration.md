# Public Certificate Authority API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/publicca.googleapis.com).
...
- **Root URL**: `https://publicca.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
