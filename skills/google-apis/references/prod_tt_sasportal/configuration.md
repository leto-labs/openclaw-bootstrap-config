# SAS Portal API (Testing) - Configuration

## Enable the API

```bash
gcloud services enable prod_tt_sasportal.googleapis.com
```

Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/prod_tt_sasportal.googleapis.com).
