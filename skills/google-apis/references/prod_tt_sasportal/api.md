# SAS Portal API (Testing) - API Reference
...
|--------|------|------|-------------|
| `prod_tt_sasportal.customers.get` | GET | `v1alpha1/{+name}` | Returns a requested customer. |
| `prod_tt_sasportal.customers.list` | GET | `v1alpha1/customers` | Returns a list of requested customers. |
| `prod_tt_sasportal.customers.patch` | PATCH | `v1alpha1/{+name}` | Updates an existing customer. |
| `prod_tt_sasportal.customers.listGcpProjectDeployments` | GET | `v1alpha1/customers:listGcpProjectDeployments` | Returns a list of SAS deployments associated with current GCP project. Includes whether SAS analy... |
| `prod_tt_sasportal.customers.provisionDeployment` | POST | `v1alpha1/customers:provisionDeployment` | Creates a new SAS deployment through the GCP workflow. Creates a SAS organization if an organizat... |
| `prod_tt_sasportal.customers.listLegacyOrganizations` | GET | `v1alpha1/customers:listLegacyOrganizations` | Returns a list of legacy organizations. |
| `prod_tt_sasportal.customers.migrateOrganization` | POST | `v1alpha1/customers:migrateOrganization` | Migrates a SAS organization to the cloud. This will create GCP projects for each deployment and a... |
| `prod_tt_sasportal.customers.setupSasAnalytics` | POST | `v1alpha1/customers:setupSasAnalytics` | Setups the a GCP Project to receive SAS Analytics messages via GCP Pub/Sub with a subscription to... |
| `prod_tt_sasportal.customers.devices.create` | POST | `v1alpha1/{+parent}/devices` | Creates a device under a node or customer. |
| `prod_tt_sasportal.customers.devices.createSigned` | POST | `v1alpha1/{+parent}/devices:createSigned` | Creates a signed device under a node or customer. |
| `prod_tt_sasportal.customers.devices.delete` | DELETE | `v1alpha1/{+name}` | Deletes a device. |
| `prod_tt_sasportal.customers.devices.get` | GET | `v1alpha1/{+name}` | Gets details about a device. |
| `prod_tt_sasportal.customers.devices.list` | GET | `v1alpha1/{+parent}/devices` | Lists devices under a node or customer. |
| `prod_tt_sasportal.customers.devices.move` | POST | `v1alpha1/{+name}:move` | Moves a device under another node or customer. |
| `prod_tt_sasportal.customers.devices.patch` | PATCH | `v1alpha1/{+name}` | Updates a device. |
| `prod_tt_sasportal.customers.devices.updateSigned` | PATCH | `v1alpha1/{+name}:updateSigned` | Updates a signed device. |
| `prod_tt_sasportal.customers.devices.signDevice` | POST | `v1alpha1/{+name}:signDevice` | Signs a device. |
| `prod_tt_sasportal.customers.nodes.create` | POST | `v1alpha1/{+parent}/nodes` | Creates a new node. |
| `prod_tt_sasportal.customers.nodes.delete` | DELETE | `v1alpha1/{+name}` | Deletes a node. |
| `prod_tt_sasportal.customers.nodes.get` | GET | `v1alpha1/{+name}` | Returns a requested node. |
| `prod_tt_sasportal.customers.nodes.list` | GET | `v1alpha1/{+parent}/nodes` | Lists nodes. |
| `prod_tt_sasportal.customers.nodes.move` | POST | `v1alpha1/{+name}:move` | Moves a node under another node or customer. |
| `prod_tt_sasportal.customers.nodes.patch` | PATCH | `v1alpha1/{+name}` | Updates an existing node. |
| `prod_tt_sasportal.customers.nodes.devices.create` | POST | `v1alpha1/{+parent}/devices` | Creates a device under a node or customer. |
| `prod_tt_sasportal.customers.nodes.devices.createSigned` | POST | `v1alpha1/{+parent}/devices:createSigned` | Creates a signed device under a node or customer. |
| `prod_tt_sasportal.customers.nodes.devices.list` | GET | `v1alpha1/{+parent}/devices` | Lists devices under a node or customer. |
| `prod_tt_sasportal.customers.nodes.nodes.create` | POST | `v1alpha1/{+parent}/nodes` | Creates a new node. |
| `prod_tt_sasportal.customers.nodes.nodes.list` | GET | `v1alpha1/{+parent}/nodes` | Lists nodes. |
| `prod_tt_sasportal.customers.nodes.deployments.create` | POST | `v1alpha1/{+parent}/deployments` | Creates a new deployment. |
| `prod_tt_sasportal.customers.nodes.deployments.list` | GET | `v1alpha1/{+parent}/deployments` | Lists deployments. |
| `prod_tt_sasportal.customers.deployments.create` | POST | `v1alpha1/{+parent}/deployments` | Creates a new deployment. |
| `prod_tt_sasportal.customers.deployments.delete` | DELETE | `v1alpha1/{+name}` | Deletes a deployment. |
| `prod_tt_sasportal.customers.deployments.get` | GET | `v1alpha1/{+name}` | Returns a requested deployment. |
| `prod_tt_sasportal.customers.deployments.list` | GET | `v1alpha1/{+parent}/deployments` | Lists deployments. |
| `prod_tt_sasportal.customers.deployments.patch` | PATCH | `v1alpha1/{+name}` | Updates an existing deployment. |
| `prod_tt_sasportal.customers.deployments.move` | POST | `v1alpha1/{+name}:move` | Moves a deployment under another node or customer. |
| `prod_tt_sasportal.customers.deployments.devices.create` | POST | `v1alpha1/{+parent}/devices` | Creates a device under a node or customer. |
| `prod_tt_sasportal.customers.deployments.devices.createSigned` | POST | `v1alpha1/{+parent}/devices:createSigned` | Creates a signed device under a node or customer. |
| `prod_tt_sasportal.customers.deployments.devices.list` | GET | `v1alpha1/{+parent}/devices` | Lists devices under a node or customer. |
| `prod_tt_sasportal.nodes.get` | GET | `v1alpha1/{+name}` | Returns a requested node. |
| `prod_tt_sasportal.nodes.devices.create` | POST | `v1alpha1/{+parent}/devices` | Creates a device under a node or customer. |
| `prod_tt_sasportal.nodes.devices.createSigned` | POST | `v1alpha1/{+parent}/devices:createSigned` | Creates a signed device under a node or customer. |
| `prod_tt_sasportal.nodes.devices.delete` | DELETE | `v1alpha1/{+name}` | Deletes a device. |
| `prod_tt_sasportal.nodes.devices.get` | GET | `v1alpha1/{+name}` | Gets details about a device. |
| `prod_tt_sasportal.nodes.devices.list` | GET | `v1alpha1/{+parent}/devices` | Lists devices under a node or customer. |
| `prod_tt_sasportal.nodes.devices.move` | POST | `v1alpha1/{+name}:move` | Moves a device under another node or customer. |
| `prod_tt_sasportal.nodes.devices.patch` | PATCH | `v1alpha1/{+name}` | Updates a device. |
| `prod_tt_sasportal.nodes.devices.updateSigned` | PATCH | `v1alpha1/{+name}:updateSigned` | Updates a signed device. |
| `prod_tt_sasportal.nodes.devices.signDevice` | POST | `v1alpha1/{+name}:signDevice` | Signs a device. |
| `prod_tt_sasportal.nodes.nodes.create` | POST | `v1alpha1/{+parent}/nodes` | Creates a new node. |
| `prod_tt_sasportal.nodes.nodes.delete` | DELETE | `v1alpha1/{+name}` | Deletes a node. |
| `prod_tt_sasportal.nodes.nodes.get` | GET | `v1alpha1/{+name}` | Returns a requested node. |
| `prod_tt_sasportal.nodes.nodes.list` | GET | `v1alpha1/{+parent}/nodes` | Lists nodes. |
| `prod_tt_sasportal.nodes.nodes.move` | POST | `v1alpha1/{+name}:move` | Moves a node under another node or customer. |
| `prod_tt_sasportal.nodes.nodes.patch` | PATCH | `v1alpha1/{+name}` | Updates an existing node. |
| `prod_tt_sasportal.nodes.nodes.devices.create` | POST | `v1alpha1/{+parent}/devices` | Creates a device under a node or customer. |
| `prod_tt_sasportal.nodes.nodes.devices.createSigned` | POST | `v1alpha1/{+parent}/devices:createSigned` | Creates a signed device under a node or customer. |
| `prod_tt_sasportal.nodes.nodes.devices.list` | GET | `v1alpha1/{+parent}/devices` | Lists devices under a node or customer. |
| `prod_tt_sasportal.nodes.nodes.nodes.create` | POST | `v1alpha1/{+parent}/nodes` | Creates a new node. |
| `prod_tt_sasportal.nodes.nodes.nodes.list` | GET | `v1alpha1/{+parent}/nodes` | Lists nodes. |
| `prod_tt_sasportal.nodes.nodes.deployments.create` | POST | `v1alpha1/{+parent}/deployments` | Creates a new deployment. |
| `prod_tt_sasportal.nodes.nodes.deployments.list` | GET | `v1alpha1/{+parent}/deployments` | Lists deployments. |
| `prod_tt_sasportal.nodes.deployments.delete` | DELETE | `v1alpha1/{+name}` | Deletes a deployment. |
| `prod_tt_sasportal.nodes.deployments.get` | GET | `v1alpha1/{+name}` | Returns a requested deployment. |
| `prod_tt_sasportal.nodes.deployments.list` | GET | `v1alpha1/{+parent}/deployments` | Lists deployments. |
| `prod_tt_sasportal.nodes.deployments.patch` | PATCH | `v1alpha1/{+name}` | Updates an existing deployment. |
| `prod_tt_sasportal.nodes.deployments.move` | POST | `v1alpha1/{+name}:move` | Moves a deployment under another node or customer. |
| `prod_tt_sasportal.nodes.deployments.devices.create` | POST | `v1alpha1/{+parent}/devices` | Creates a device under a node or customer. |
| `prod_tt_sasportal.nodes.deployments.devices.createSigned` | POST | `v1alpha1/{+parent}/devices:createSigned` | Creates a signed device under a node or customer. |
| `prod_tt_sasportal.nodes.deployments.devices.list` | GET | `v1alpha1/{+parent}/devices` | Lists devices under a node or customer. |
| `prod_tt_sasportal.installer.generateSecret` | POST | `v1alpha1/installer:generateSecret` | Generates a secret to be used with the ValidateInstaller. |
| `prod_tt_sasportal.installer.validate` | POST | `v1alpha1/installer:validate` | Validates the identity of a Certified Professional Installer (CPI). |
| `prod_tt_sasportal.deployments.get` | GET | `v1alpha1/{+name}` | Returns a requested deployment. |
| `prod_tt_sasportal.deployments.devices.delete` | DELETE | `v1alpha1/{+name}` | Deletes a device. |
| `prod_tt_sasportal.deployments.devices.get` | GET | `v1alpha1/{+name}` | Gets details about a device. |
| `prod_tt_sasportal.deployments.devices.move` | POST | `v1alpha1/{+name}:move` | Moves a device under another node or customer. |
| `prod_tt_sasportal.deployments.devices.patch` | PATCH | `v1alpha1/{+name}` | Updates a device. |
| `prod_tt_sasportal.deployments.devices.updateSigned` | PATCH | `v1alpha1/{+name}:updateSigned` | Updates a signed device. |
| `prod_tt_sasportal.deployments.devices.signDevice` | POST | `v1alpha1/{+name}:signDevice` | Signs a device. |
| `prod_tt_sasportal.policies.set` | POST | `v1alpha1/policies:set` | Sets the access control policy on the specified resource. Replaces any existing policy. |
| `prod_tt_sasportal.policies.get` | POST | `v1alpha1/policies:get` | Gets the access control policy for a resource. Returns an empty policy if the resource exists and... |
| `prod_tt_sasportal.policies.test` | POST | `v1alpha1/policies:test` | Returns permissions that a caller has on the specified resource. |
...
```typescript
const res = await prod_tt_sasportal.devices.create({
  // parameters
});
```
...
```typescript
const res = await prod_tt_sasportal.devices.createSigned({
  // parameters
});
```
...
```typescript
const res = await prod_tt_sasportal.devices.delete({
  // parameters
});
```
...
```typescript
const res = await prod_tt_sasportal.devices.get({
  // parameters
});
```
...
```typescript
const res = await prod_tt_sasportal.devices.list({
  // parameters
});
```
...
```typescript
const res = await prod_tt_sasportal.devices.move({
  // parameters
});
```
...
```typescript
const res = await prod_tt_sasportal.devices.patch({
  // parameters
});
```
...
```typescript
const res = await prod_tt_sasportal.devices.updateSigned({
  // parameters
});
```
...
```typescript
const res = await prod_tt_sasportal.devices.signDevice({
  // parameters
});
```
...
```typescript
const res = await prod_tt_sasportal.nodes.create({
  // parameters
});
```
...
```typescript
const res = await prod_tt_sasportal.nodes.delete({
  // parameters
});
```
...
```typescript
const res = await prod_tt_sasportal.nodes.list({
  // parameters
});
```
...
```typescript
const res = await prod_tt_sasportal.nodes.move({
  // parameters
});
```
...
```typescript
const res = await prod_tt_sasportal.nodes.patch({
  // parameters
});
```
...
```typescript
const res = await prod_tt_sasportal.deployments.create({
  // parameters
});
```
...
```typescript
const res = await prod_tt_sasportal.deployments.list({
  // parameters
});
```
...
```typescript
const res = await prod_tt_sasportal.deployments.delete({
  // parameters
});
```
...
```typescript
const res = await prod_tt_sasportal.deployments.patch({
  // parameters
});
```
...
```typescript
const res = await prod_tt_sasportal.deployments.move({
  // parameters
});
```
