# Cloud Spanner API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/spanner.googleapis.com).
...
| `https://www.googleapis.com/auth/spanner.data` | See, edit, configure, and delete your Google Cloud Spanner data and see the email address for your Google Account |
