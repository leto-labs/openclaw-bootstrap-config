# Advisory Notifications API - Configuration
...
Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/advisorynotifications.googleapis.com).
...
- **Root URL**: `https://advisorynotifications.googleapis.com/`
- **Service path**: ``
- **Batch path**: `batch`
