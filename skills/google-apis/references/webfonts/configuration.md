# Web Fonts Developer API - Configuration

## Enable the API

```bash
gcloud services enable webfonts.googleapis.com
```

Or enable via [Google Cloud Console](https://console.cloud.google.com/apis/library/webfonts.googleapis.com).
