# Accelerated Mobile Pages (AMP) URL API - Gotchas & Troubleshooting
...
- Always enable `acceleratedmobilepageurl.googleapis.com` in your GCP project before making calls
